...
namespace Coding_prac
{
    interface ICompany
    {
        public abstract int CalWage(String compName, int emp_rate_per_hr, int no_work_days, int max_hrs_in_mon);
    }
    public class Company : ICompany
    {
        ...
        public int CalWage(String compName, int emp_rate_per_hr, int no_work_days, int max_hrs_in_mon)
        {
            ///Variables
            int emphrs = 0;
            int totalemphrs = 0;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 1; i <= n; i++)
            {
                ...
                int cw1 = c.CalWage(compName1, Convert.ToInt32(emp_rate_per_hr), Convert.ToInt32(no_of_work_days), Convert.ToInt32(max_hrs_in_mon));
